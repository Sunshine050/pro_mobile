...
const Room = {
  ...
  create: (roomData, callback) => {
    const query = 'INSERT INTO rooms (`room_name`, `description`, `slot_1`, `slot_2`, `slot_3`, `slot_4`, `image`, `user_id`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)';
    db.query(query, [roomData.room_name, roomData.description, roomData.slot_1, roomData.slot_2, roomData.slot_3, roomData.slot_4, roomData.image, roomData.user_id], callback);
  },
  update: function (roomId, roomData, callback) {
